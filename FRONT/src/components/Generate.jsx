...
const Generate = () => {
   ...
   const FolderImages = [
    ...
    setTimeout(() => setSpinner(false), 12000)
    ...
    return <div>
      ...
      position:"inherit"}}>
            ...
            <div className="App hero__section--container">
                ...
                {loading ? null :
          <div>
          <img src={"assets/images/epochs64_3.gif"}/>
          <p style={{position:"relative", bottom:"0"}}>Modeluję...</p>
          </div>
        }
        <img className="generated_image"
          style={loading ? {} : {display: 'none',  width:'512px'}}
          src={imageUrl}
            onLoad={() => setTimeout(()=>setLoading(true),2000)}
        />
